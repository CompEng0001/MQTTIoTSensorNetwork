...
const char* clientID = "outside/"; // MQTT client ID change to your own client and ammend each topic to match 
const char* humidity_topic = "outside/humidity";
const char* temperature_topic = "outside/temperature";
const char* pressure_topic = "outside/pressure";
const char* iaq_topic = "outside/iaq";
const char* mq5_topic = "outside/mq5";
const char* dust_topic = "outside/dust";
