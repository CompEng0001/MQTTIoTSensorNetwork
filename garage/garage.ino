...
const char* clientID = "garage/"; // MQTT client ID change to your own client and ammend each topic to match 
const char* humidity_topic = "garage/humidity";
const char* temperature_topic = "garage/temperature";
const char* pressure_topic = "garage/pressure";
const char* iaq_topic = "garage/iaq";
const char* mq5_topic = "garage/mq5";
const char* dust_topic = "garage/dust";
